...
class UserControllerTest {
    ...
    void register_ShouldReturnCreatedUser() {
        ...
        UserResponse expected = UserResponse.map(newUser);
        when(userService.register(newUser)).thenReturn(expected);

        // Act
        ResponseEntity<UserResponse> response = userController.register(newUser);
